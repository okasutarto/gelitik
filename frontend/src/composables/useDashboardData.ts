...
export function useDashboardData() {
  ...
  const kpiCards = computed(() => {
    ...
    return [
      ...
      {
        title:"Total Likes",
        value: formatNumber(dashboardStore.totalLikes),
        rawValue: dashboardStore.totalLikes,
        subtitle: "Combined platform likes",
        delta: deltas.likes.delta,
        deltaPercent: deltas.likes.percent,
        deltaLabel: "vs. first record",
      },
      {
