...
<template>
  <button
    @click="handleClick"
    :disabled="loading"
    class="group flex w-full cursor-pointer items-center justify-center rounded-xl h-12 px-4 
           bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 
           hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors gap-3
