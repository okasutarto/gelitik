  ...
  <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
      ...
      <select
        ...
        class="bg-slate-50 dark:bg-slate-700 border-none text-sm font-semibold rounded-lg 
               text-slate-600 dark:text-slate-300 py-2 px-3 
               focus:ring-2 focus:ring-primary-500 cursor-pointer outline-none"
      >
