...
<template>
  ...
  >
    ...
    <!-- Facebook SVG -->
    <svg v-else-if="provider === 'facebook'" class="w-5 h-5" viewBox="0 0 24 24" fill="#1877F2">
      <path
    ...
    <!-- Twitter (X) SVG -->
    <svg v-else-if="provider === 'twitter'" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      <path
    ...
    <!-- LinkedIn SVG -->
    <svg v-else-if="provider === 'linkedin'" class="w-5 h-5" viewBox="0 0 24 24" fill="#0A66C2">
      <path
    ...
    <!-- Instagram Icon -->
    <Instagram v-else-if="provider === 'instagram'" class="w-5 h-5 text-pink-600" :size="20" />
