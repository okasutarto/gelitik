...
import { Eye, Heart, UserCheck, Activity, Calendar, ChevronDown, Download } from 'lucide-vue-next'
import DashboardLayout from '@/layouts/DashboardLayout.vue'
import ExportReportModal from '@/components/dashboard/reports/ExportReportModal.vue'
import PageHeader from '@/components/layout/PageHeader.vue'
import InsightCard from '@/components/dashboard/cards/InsightCard.vue'
...
<template>
    <DashboardLayout>
        ...
        <!-- Filter Actions Row -->
        <div v-if="!loading" class="flex justify-end mt-6 relative gap-3">
            <!-- Export Action -->
            <button
