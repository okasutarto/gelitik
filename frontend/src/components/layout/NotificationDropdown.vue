...
<template>
    <div
        v-if="isOpen"
        class="notification-dropdown fixed inset-0 z-50"
        ...
        <div
            ...
            <!-- Header -->
            <div class="flex items-center justify-between px-4 py-3 bg-neo-accent dark:bg-hotpink border-b-4 border-black dark:border-electric">
                <div class="flex items-center gap-2">
                    <Bell :size="20" class="text-black dark:text-navy" />
                    <h3 class="font-black text-lg text-black dark:text-navy tracking-tight">
                        NOTIFICATIONS
                    </h3>
                    <span
            ...
            <div class="flex-1 overflow-y-auto">
                ...
                <div
                    ...
                    <div class="w-16 h-16 mb-4 bg-slate-100 dark:bg-slate-800 border-2 border-black dark:border-electric flex items-center justify-center">
                    ...
                    <button
                        ...
                        <div
                            :class="[
                                ...
                                notification.type === 'post_failed' ? 'bg-red-100 dark:bg-red-900/30' :
                                notification.type === 'account_connected' ? 'bg-green-100 dark:bg-green-900/30' :
                                notification.type === 'post_published' ? 'bg-blue-100 dark:bg-blue-900/30' :
                            ...
                            <component
                                ...
                                :size="18"
                                :class="[
                                    notification.type === 'post_failed' ? 'text-red-600 dark:text-red-400' :
                                    notification.type === 'account_connected' ? 'text-green-600 dark:text-green-400' :
                                    notification.type === 'post_published' ? 'text-blue-600 dark:text-blue-400' :
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-2">
                                <p :class="[
                                    ...
                                    notification.read ? 'text-slate-600 dark:text-slate-400' : 'text-black dark:text-white'
                                ]">
                                    {{ notification.title }}
                                </p>
