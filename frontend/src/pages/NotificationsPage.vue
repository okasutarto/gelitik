...
const getTypeColor = (type: string) => {
    switch (type) {
        case 'post_failed': return 'bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 border-red-300 dark:border-red-700'
        case 'account_connected': return 'bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 border-green-300 dark:border-green-700'
        case 'post_published': return 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border-blue-300 dark:border-blue-700'
        case 'post_scheduled': return 'bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 border-purple-300 dark:border-purple-700'
        case 'comment': return 'bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 border-orange-300 dark:border-orange-700'
        case 'mention': return 'bg-cyan-100 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400 border-cyan-300 dark:border-cyan-700'
        default: return 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-slate-300 dark:border-slate-700'
    }
}

const getTypeLabel = (type: string) => {
    switch (type) {
        case 'account_connected': return 'Connected'
        case 'token_expiring': return 'Warning'
        ...
        <div class="h-full flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto">
                ...
                <div
                    ...
                    <div class="w-24 h-24 mb-6 bg-slate-100 dark:bg-slate-800 border-4 border-black dark:border-electric flex items-center justify-center shadow-brutal-sm">
                    ...
                    <p class="text-slate-600 dark:text-slate-400 max-w-md">
                        You're all caught up! Check back later for notifications about your connected accounts and scheduled posts.
                    </p>
                </div>
                            ...
                            <div class="flex items-center gap-4 mt-3">
                                ...
                                <div
                                    ...
                                    <span class="text-sm text-slate-500 capitalize">
                                        {{ notification.platform === 'instagram-graph' ? 'Instagram Business' : notification.platform }}
                                    </span>
                                </div>
                                ...
                                <div
                                    ...
                                    class="ml-auto">
                                    <span class="px-2 py-1 text-xs font-bold uppercase tracking-wide bg-cyan-500 text-white rounded">
                                        New
                                    </span>
                                </div>
                            </div>
