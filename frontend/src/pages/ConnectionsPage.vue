...
<template>
  <DashboardLayout>
    <div class="mb-6">
      <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Connected Accounts</h2>
    ...
    <div v-else-if="accounts.length > 0" class="space-y-4">
      <div
        ...
        :key="account.id"
        class="flex items-center justify-between rounded-xl bg-white dark:bg-slate-800 p-4"
      >
        <div class="flex items-center gap-4">
          ...
          <div>
            <h3 class="font-semibold text-slate-900 dark:text-white">{{ account.displayName }}</h3>
    ...
    <div v-else class="text-center py-12">
      ...
      <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-2">No accounts connected</h3>
    ...
    <div class="mt-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <span class="font-medium text-slate-700 dark:text-slate-300">Connect Instagram</span>
        </button>
        ...
        >
          ...
          <span class="font-medium text-slate-700 dark:text-slate-300">Connect TikTok</span>
        </button>
      </div>
    </div>
  </DashboardLayout>
