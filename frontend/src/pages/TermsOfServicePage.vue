        ...
        <div class="p-8 space-y-8">
          <section>
            ...
            <p class="text-slate-700 dark:text-slate-300 leading-relaxed">
              By accessing and using Gelitik, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service.
            </p>
          </section>
          ...
          <section>
            ...
            <p class="text-slate-700 dark:text-slate-300 leading-relaxed">
              Gelitik is a social media management platform that provides tools for scheduling, analytics, and managing social media accounts across multiple platforms.
            </p>
          </section>
          ...
          <section>
            ...
            <p class="text-slate-700 dark:text-slate-300 leading-relaxed">
              All content, features, and functionality of Gelitik are owned by Gelitik Lab and are protected by international copyright, trademark, and other intellectual property laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p class="text-slate-700 dark:text-slate-300 leading-relaxed">
              Gelitik shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the service.
            </p>
          </section>
