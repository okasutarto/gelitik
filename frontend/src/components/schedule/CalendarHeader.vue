...
<template>
  <div
    ...
    <div class="flex items-center gap-3 w-full sm:w-auto">
      <button
        class="hidden md:flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 rounded-2xl border-neo-3 border-black text-slate-600 dark:text-slate-300 text-sm font-bold hover:bg-neo-accent hover:-translate-y-1">
        <Filter :size="16" />
        Filter
      </button>
